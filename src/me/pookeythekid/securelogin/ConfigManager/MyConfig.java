package me.pookeythekid.securelogin.ConfigManager;
...
public class MyConfig 
{
    ...
    public float getFloat(String path) {return (float) this.config.getDouble(path);}
    
    public float getFloat(String path, long def) {return (float) this.config.getDouble(path, def);}
